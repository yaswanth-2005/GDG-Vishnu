...
const LeaderCard: React.FC<props_LeaderCard> = ({ leaderName, index }) => {
    ...
    return (
        <motion.div
            ...
            className={`${isAnimating && 'pointer-events-none'} hover:z-20 outline-2 outline-[#3c910b] outline relative group opacity-0 hover:rounded-b-none hover:!scale-105 transition duration-300 ease-out select-none rounded-xl bg-gradient-to-t from-[#040404] via-[#64c72b] to-[#1f3f0d]`}
            key={leaderName}
        >
...
export default function Leadership(): React.ReactNode {
    return (
        <div>
            <div className='w-full h-[25vh] bg-gradient-to-b from-black to-green-950'></div>
            <div className='w-full h-full py-80 text-gray-300 bg-[#1f3f0d]'>
