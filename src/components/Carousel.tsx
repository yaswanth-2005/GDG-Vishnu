                ...
                >
                    ...
                    <div className='py-4'>
                        <Link
                            ...
                            target='_blank'
                            rel='noreferrer'
                            className='inline-flex items-center justify-center px-6 py-2 text-white bg-gray-800 rounded-md shadow-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-all duration-200'
                        >
                            <Globe className='mr-2' size={20} />
                            <span>View More about this event</span>
                        </Link>
                    </div>
                </div>
                            ...
                            {Object.entries(projects).map(([projectName]) => (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div
                                            className='z-0 absolute top-0 w-full h-full bg-gradient-to-t
